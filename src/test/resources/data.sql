...
INSERT INTO USER_TAB (USER_ID, USERNAME, PASSWORD, ROLE_ID) VALUES (100, 'victoria','{bcrypt}$2a$10$Z.y5qu2v2/LIuzsDaHLEsOReksoMQmNC1CVasO9rUopRkRlUgtGc6', 1);
INSERT INTO USER_TAB (USER_ID, USERNAME, PASSWORD, ROLE_ID) VALUES (200,  'bartosz','{bcrypt}$2a$10$Z.y5qu2v2/LIuzsDaHLEsOReksoMQmNC1CVasO9rUopRkRlUgtGc6', 2);
INSERT INTO USER_TAB (USER_ID, USERNAME, PASSWORD, ROLE_ID) VALUES (300, 'kasia','{bcrypt}$2a$10$Z.y5qu2v2/LIuzsDaHLEsOReksoMQmNC1CVasO9rUopRkRlUgtGc6', 1);
INSERT INTO USER_TAB (USER_ID, USERNAME, PASSWORD, ROLE_ID) VALUES (400, 'manhton','{bcrypt}$2a$10$Z.y5qu2v2/LIuzsDaHLEsOReksoMQmNC1CVasO9rUopRkRlUgtGc6', 4);
INSERT INTO USER_TAB (USER_ID, USERNAME, PASSWORD, ROLE_ID) VALUES (500, 'raffael','{bcrypt}$2a$10$Z.y5qu2v2/LIuzsDaHLEsOReksoMQmNC1CVasO9rUopRkRlUgtGc6', 1);
...
INSERT INTO EXPENSE_TAB (EXPENSE_ID, NAME, TOTAL, EXPENSE_DATE, CATEGORY_ID, SHOP_ID, EMPLOYEE_ID, STATUS, NOTE) VALUES (200, 'expense_2', 9.05, CURRENT_DATE, 200, 200, 100, 'PENDING', 'Note 2');
