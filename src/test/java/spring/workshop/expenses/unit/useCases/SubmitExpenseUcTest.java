...
public class SubmitExpenseUcTest {
    ...
    public void submitExpenseTest() {
        // Given
        Employee employee = new Employee(200L, "Employee", new User(), new Superior());
        ...
        // When
        Expense submittedExpense = submitExpenseUc.submitExpense(100L, 200L);
    ...
    public void submitExpenseNegativExpenseStatusIncorrectTest() {
        ...
        Exception exception = assertThrows(ForbiddenResourceException.class,
                () -> submitExpenseUc.submitExpense(100L, 200L));
    ...
    public void submitExpenseNegativEmployeeIdIncorrectTest() {
        ...
        when(expenseServiceMock.getExpenseById(any())).thenReturn(expense);
        when(employeeServiceMock.getEmployeeById(any())).thenReturn(notAuthorizedEmployee);

        // When
        // Then
        Exception exception = assertThrows(ForbiddenResourceException.class,
                () -> submitExpenseUc.submitExpense(100L, 300L));
