...
public class ApproveOrRejectExpenseUcTest {
    ...
    public void approveExpenseTest(){
        ...
        Expense approvedExpense = sut.approveOrRejectExpense(expense.getId(), superior.getId(), ExpenseStatus.APPROVED, "example_approve_note_1");
    ...
    public void rejectExpenseTest(){
        ...
        Expense approvedExpense = sut.approveOrRejectExpense(expense.getId(), superior.getId(), ExpenseStatus.REJECTED, "example_reject_note_1");
    ...
    public void acceptExpenseNichtRichtigerSuperiorTest(){
        ...
        Exception exception = assertThrows(ResourceNotFoundException.class,() -> sut.approveOrRejectExpense(expense.getId(), 3L, ExpenseStatus.REJECTED, "example_reject_note_1"));
